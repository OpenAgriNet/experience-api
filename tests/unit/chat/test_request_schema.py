...
@pytest.mark.parametrize(
    ...
    [
        ...
        _with("messageId", ...),
        _with("messageId", "42"),
        _with("sessionId", "68a3872f3f0d4cf699a3a350132a0080"),
        _with("sessionId", "{68a3872f-3f0d-4cf6-99a3-a350132a0080}"),
        _with("messageId", "urn:uuid:1ab38d6c-6fdb-4849-8ea1-da5e80a8687c"),
        _with("messageId", 42),
        _with("query", ...),
        _with("query", ""),
        _with("query", "   \n"),
